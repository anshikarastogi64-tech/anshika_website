...
// Admin email
$admin_email = 'designersvisionstudio@gmail.com';
...
$customer_subject = '✨ Welcome to Your Dream Journey, ' . $name . '!';
...
$customer_headers = array(
    ...
    'Reply-To: designersvisionstudio@gmail.com',
    'X-Mailer: PHP/' . phpversion()
);

$customer_mail_sent = mail($email, $customer_subject, $customer_email_body, implode("\r\n", $customer_headers));

// Response
if ($mail_sent && $customer_mail_sent) {
    ...
    echo json_encode([
        'success' => true,
        'message' => 'Admin email sent, but customer email failed. Please follow up manually.'
    ]);
} else {
