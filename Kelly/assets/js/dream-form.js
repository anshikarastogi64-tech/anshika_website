(function() {
  ...
  const CONFIG = {
    ...
    emailEndpoint: '/Kelly/forms/dream-contact' // Node.js API endpoint
  };
  ...
  // Send to admin email using Node.js backend
  async function sendToAdmin(data) {
    console.log('Sending email to:', CONFIG.emailEndpoint);
